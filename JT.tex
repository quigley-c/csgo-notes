...
\begin{itemize}
	\item He likes to take risks by challenging enemy players to duels that he is even or slightly disadvantaged
	in. His willingness to do so is likely influenced by his good flicking ability.

	\item JT has a tendancy to go for ninja defuses. While not necessarily a bad idea, he should be aware of
	situations where it may be beneficial to attempt to win by taking duels at isolated angles instead.

	\item Occasionally JT finds himself in a position where he must make a choice on limited information.
